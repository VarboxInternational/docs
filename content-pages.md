...
- [Usage](#usage)
    ...
    - [Manage File Uploads](#manage-file-uploads)
    - [Render Location Blocks](#render-location-blocks)
...
Before you learn about using your pages inside a [VarBox](/) application, you should know that there's already a section in the admin from where you can manage all your pages.
...
Now that you've grasped the concept behind the pages component, it's time to put it to use.
...
All you have to do in order to display that page's info on your frontend is to create the `resources/views/pages/show.blade.php` view file.
...
<a name="add-extra-fields"></a>
#### Add Extra Fields

More often than not, in your applications you'll want different fields for your pages.
...
To create a new page, go to `config/varbox/pages.php` and under the `types` section, add your new page type  configuration. 
...
For more information on how you can customize the pages functionality, please read the comments from that file.
