...
- [How It Works](#how-it-works)
    ...
    - [The Block Files](#the-block-files)
...
Before you learn about using your blocks inside a [VarBox](/) application, you should know that there's already a section in the admin from where you can manage all your blocks.

You can find the pages section inside [Admin -> Manage Content -> Blocks](/docs/{{version}}/blocks-interface).   
...
Now that you've grasped the concept behind the blocks component, it's time to put it to use.
...
For more information on how you can customize the blocks functionality, please read the comments from that file.
