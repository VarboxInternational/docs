...
For an example on how to add translatable fields to [Content Pages](/docs/{{version}}/content-management#content-pages), please follow this [Full Example](/docs/{{version}}/example-translatable).
